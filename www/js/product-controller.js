angular.module('starter.product-controller', [])
    ...
    .controller('ProductListCtrl', function ($scope, $state, $window, $stateParams, $ionicHistory) {
        ...
        $scope.products = [
            ...
            {count: 1, price: 2288, name : '杭之吻毛呢外套女中长款加厚修身型呢子大衣女冬装显瘦韩款潮 1051皮粉色(带真毛领) M加棉加厚', image : 'http://m.360buyimg.com/n8/jfs/t2290/267/1197246933/268424/462ad641/5681f45eNfb43facc.jpg!q70.jpg'},
