angular.module('starter.product-controller', [])
    ...
    .controller('ProductListCtrl', function ($scope, $state, $window, $stateParams) {

        console.debug($stateParams.categoryid);

        $scope.products = [
            {price: 288, name : '美莱香 2015秋冬新款韩版加棉毛呢大衣女外套修身中长款羊毛呢子大衣加厚女装MW888 枣红色加棉 M', image : 'http://m.360buyimg.com/n8/jfs/t2557/184/1007246708/390166/530a5510/56800659N30321307.jpg!q70.jpg'},
            {price: 2288, name : '杭之吻毛呢外套女中长款加厚修身型呢子大衣女冬装显瘦韩范版毛领新款潮 1051皮粉色(带真毛领) M加棉加厚', image : 'http://m.360buyimg.com/n8/jfs/t2290/267/1197246933/268424/462ad641/5681f45eNfb43facc.jpg!q70.jpg'},
            {price: 1288, name : '衣锦霓裳 2015秋冬装新款毛呢大衣女中长款韩版外套 酒红色 M', image : 'http://m.360buyimg.com/n8/jfs/t2476/70/1022892578/288502/2e31b6e5/563dd658N04dc0daa.jpg'},
        ];
    ...
    .controller('ProductDetailCtrl', function ($scope, $state, $window, $stateParams, $ionicHistory) {
        ...
        $scope.product = {
            name : '澳贝琳 2015秋冬新款韩版修身显瘦中长款毛呢大衣女外套  8615  灰色 L', price: 129,
